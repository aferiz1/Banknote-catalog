...
import ShowCurrenciesInteractor from "../../currency/interactor/ShowCurrenciesInteractor";
import DeleteCurrencyInteractor from "../../currency/interactor/DeleteCurrencyInteractor";
import EditCurrencyInteractor from "../../currency/interactor/EditCurrencyInteractor";
import AddCurrencyInteractor from "../../currency/interactor/AddCurrencyInteractor";
import GetCountriesInteractor from "../../countries/interactor/GetCountriesInteractor";
import GetCurrenciesInteractor from "../../currency/interactor/GetCurrenciesInteractor";
import CurrencyService from "../../currency/service/CurrencyService";
...
const ModuleContainer = (
  ...
  _container.register({
    ...
    currencyService: asFunction(CurrencyService)
  });
  ...
  _container.register({
    ...
    getCurrencies: asInteractor(ShowCurrenciesInteractor),
    deleteCurrency: asInteractor(DeleteCurrencyInteractor),
    editCurrency: asInteractor(EditCurrencyInteractor),
    addCurrency: asInteractor(AddCurrencyInteractor),
    getCountries: asInteractor(GetCountriesInteractor),
    refreshCurrencies: asInteractor(GetCurrenciesInteractor)
  });
